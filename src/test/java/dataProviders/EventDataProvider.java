...
public class EventDataProvider {
    ...
    public static Object[][] eventData() throws Exception{
        ...
        return new Object[][]{
                /* nazwaWydarzenia, dataPoczatkowa, godzinaPoczatkowa, godzinaKonckowa, dataKoncowa, lokalizacja, kalendarz, opis, całyDzien, powtarzaj , powtRodzaj, powtCzestosc, kolor, errorMsg */
                ...
                {"wydarzenie brak koniec", "6/14/16", "17:30", "6/15/16", "", "Kraków", "testowy", "opis", false, false, 0, 0,3, ""  },
                {"wydarzenie brak koniec", "6/14/16", "17:40", "", "17:50", "Kraków", "testowy", "opis", false, false, 0, 0,4, ""   },
                {"wydarzenie zly koniec czas", "6/14/16", "13:40", "6/15/16", "30:40", "Kraków", "testowy", "opis", false, false, 0, 0,5, ""  },
                {"wydarzenie zly koniec czas", "6/14/16", "17:40", "6/15/16", "18:70", "Kraków", "testowy", "opis", false, false, 0, 0,6, ""  },
                ...
                {"wydarzenie inny kalendarz", "6/14/16", "13:40", "6/15/16", "17:50", "Kraków", "Jan", "opis", false, false, 0, 0,10, ""  },
                {"wydarzenie brak miejsca", "6/14/16", "17:40", "6/15/16", "17:40", "", "Jan", "opis", false, false, 0, 0,11, "" },
                {"wydarzenie brak opisu", "6/14/16", "17:40", "6/14/16", "16:40", "Karków", "Jan", "", false, false, 0, 0,10, ""  },
                ...
                {"wydarzenie return 0; main null", "6/14/16", "17:40", "6/15/16", "16:40", "Kraków", "testowy", "opis", false, false, 0, 0,5, ""  },
                {"wydarzenie powtarzaj", "6/14/16", "17:40", "6/15/16", "17:40", "Kraków", "testowy", "opis", false, true, 5, 1, 4, ""  },
                {"wydarzenie caly dzien", "6/14/16", "13:40", "6/15/16", "17:40", "Kraków", "testowy", "opis", true, false, 0, 0,3, ""  },
                {"wydarzenie caly dzien powratzaj", "6/14/16", "17:40", "6/15/16", "18:40", "Kraków", "testowy", "opis", true, true, 2, 5, 2, ""  }
        };

    }

    @DataProvider(name="quickEventData")
    public static Object[][] quickEventData() throws Exception {

        return new Object[][]{
                {"23:30", "tytuł", "Jan"},
                {"23:30", "", "testowy"},
                {"00:00", "tytuł2", "testowy"},
                {"06:30", "tytuł3", "Jan"}
        };
